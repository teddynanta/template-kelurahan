    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="/dashboard" class="nav-link {{ ($active === "dashboard") ? 'active menu-open' : '' }}">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link {{ ($active === "berita") ? 'active menu-open' : '' }}">
          ...
          <li class="nav-item">
            <a href="#" class="nav-link {{ ($active === "menu") ? 'active menu-open' : '' }}">
